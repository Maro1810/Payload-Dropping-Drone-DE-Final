...
$$\begin{bmatrix}\frac{X}{Z} \\\frac{Y}{Z} \\ 1\end{bmatrix}=K^{-1}\cdot \begin{bmatrix}x \\ y\\ 1\end{bmatrix}$$
...
$$Z = altitude \newline\newline Z\cdot\begin{bmatrix}\frac{X}{Z} \\\frac{Y}{Z} \\1\end{bmatrix}=\begin{bmatrix}X \\ Y\\ 1\end{bmatrix}$$
